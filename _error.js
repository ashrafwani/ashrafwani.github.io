...
(function(e) {
    ...
    function h(e) {
        if ((new Date).getTime() < r + n)
            return;
        r = (new Date).getTime();
        var t = s.offset() != null ? s.offset().left: 0, u = s.offset() != null ? s.offset().top: 0, a = e.pageX - t, h = e.pageY - u;
        ...
        var p = a / (l() == true ? o : s.width()), d = h / (l() == true ? o : s.height()), v, m;
        for (m = i.length; m--;) {
            v = i[m];
    ...
    var t = 25, n = 1 / t * 1e3, r = (new Date).getTime(), i = [], s = e(window), o = 1, u = null, a = null, f = false;
